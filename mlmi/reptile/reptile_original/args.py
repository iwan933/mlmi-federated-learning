...
def train_kwargs(parsed_args):
    ...
    """
    return {
        # Changes from original code for our purposes:
        #   1. train_shots is equal to num_shots
        #   2. replacement is set to False
        #   3. eval_inner_batch_size is equal to inner_batch_size
        #   4. transductive is set to True
        'num_classes': parsed_args.classes,
        'num_shots': parsed_args.shots,
        'train_shots': parsed_args.shots,  # (parsed_args.train_shots or None),
        'inner_batch_size': parsed_args.inner_batch,
        'inner_iters': parsed_args.inner_iters,
        'replacement': False,  # parsed_args.replacement,
        ...
        'eval_inner_batch_size': parsed_args.inner_batch,  # parsed_args.eval_batch,
...
def evaluate_kwargs(parsed_args):
    ...
    return {
        # Changes from original code for our purposes:
        #   1. eval_inner_batch_size is equal to inner_batch_size
        #   2. replacement is set to False
        #   2. transductive is set to True
        'num_classes': parsed_args.classes,
        'num_shots': parsed_args.shots,
        'eval_inner_batch_size': parsed_args.inner_batch,  # parsed_args.eval_batch,
        'eval_inner_iters': parsed_args.eval_iters,
