...
def train(sess,
    ...
    for i in range(meta_iters):
        ...
        if i % eval_interval == 0:
            ...
            tensorboard_logger.experiment.add_scalar('train-test/acc/global_model/mean', accuracies[0], global_step=i)
            tensorboard_logger.experiment.add_scalar('test-test/acc/global_model/mean', accuracies[1], global_step=i)
